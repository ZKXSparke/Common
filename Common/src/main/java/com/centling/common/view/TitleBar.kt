...
import pers.victor.ext.setPaddingBottom
...
class TitleBar : FrameLayout {
    ...
    fun setTitleBarColor(@ColorInt id: Int) = title_bar_title.setTextColor(id)
    ...
    fun setLeftTextColor(color: Int) = title_bar_left_text.setTextColor(color)

    fun setRightTextColor(color: Int) = title_bar_right_text.setTextColor(color)
    ...
    fun setBottomMargin(length: Int) = (layoutParams as LinearLayout.LayoutParams).setMargins(0, 0, 0, dp2px(length))


    fun useElevation(v: Float = 10f) {
