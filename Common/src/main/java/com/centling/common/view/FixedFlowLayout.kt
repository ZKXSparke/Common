...
class FixedFlowLayout(context: Context, attributeSet: AttributeSet) : ViewGroup(context, attributeSet) {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        eachWidth = (measuredWidth - paddingStart - paddingEnd - (columns - 1) * horizontalSpacing) / columns
        measureChildren(MeasureSpec.makeMeasureSpec(eachWidth, MeasureSpec.EXACTLY), heightMeasureSpec)
        ...
        val finalHeight = View.resolveSize(height, heightMeasureSpec)
